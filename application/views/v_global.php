        ...
        <div class="col-lg-12 col-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Data Berdasarkan Global (Seluruh Dunia)</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  <?php $no=1; foreach ($global as $key => $value) : ?>
                    <tr>
                      ...
                      <td class="text-center"><?php echo $value['attributes']['Confirmed']; ?></td>
                      <td class="text-center" ><?php echo $value['attributes']['Recovered']; ?></td>
                      <td class="text-center"><?php echo $value['attributes']['Deaths']; ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
                </table>
